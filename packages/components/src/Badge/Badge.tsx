...
const Badge = (props: BadgeProps) => {
    const { style, className, label, iconStart, iconEnd, ...restProps } = props;

    const { root: rootStyleProps, label: labelStyleProps, iconStart: iconStartStyleProps, iconEnd: iconEndStyleProps } = useBadgeStyles({ style, className });
